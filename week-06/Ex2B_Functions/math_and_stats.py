...
# Calculations on the area of a circle with a random radius

exact_area = pi * radius ** 2
area_up = math.ceil(exact_area)
area_down = math.floor(exact_area)
